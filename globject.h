...
void ImportOBJ(const char* filename, glTexture* Texture);
void ImportOBJ(const char* objfilename, const char* mtlfilename, std::vector< glTexture* > animTextures);
...
#define MAX_VAO 200 // maksymalna liczba tablic VAO w obiekcie 
